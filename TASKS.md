...
| T-116–T-187 Export suite and export planning | Completed | Consolidates T-116, T-120, T-125, T-152, and T-187: Notes PDF export, PDF formatting polish, Notes Markdown download, shared branded Forms/Notes PDF utilities with safe filenames and current visible/canonical output as source, plus final professional export-layer criteria. |
| T-013b/T-121–T-186 Notes authoring, recovery, and session UX | Completed | Consolidates T-013b, T-121, T-126, T-142, T-162, T-163, T-177, T-180, T-182, T-183, T-184, T-185, and T-186: editable final notes, local autosave/recovery, multi-segment resume context, 60-minute reliability warning UI, no forced auto-scroll, polished Actions/transform loading, stale transform handling, copy text/Markdown, aligned Markdown action icons, mobile-safe transform preview actions, bounded undo/redo, and short-window recovery UX for interrupted finalisation/transforms. |
...
| T-188 Polish Notes PDF export formatting | Backlog | P3, export polish. Improve Notes PDF typography, Markdown rendering depth, page breaks, filenames, and long-content handling while preserving current visible/canonical notes as the export source. |
| T-189 Polish Forms PDF export formatting | Backlog | P3, export polish. Improve Forms PDF grouping, multiline answers, page breaks, filenames, empty-value handling, and professional layout consistency while preserving current form values as the export source. |
| T-190 Recover interrupted active Notes recording | Completed | P1/P2, Notes reliability, cross-repo. Added resume-first UX for mobile/background recording interruptions using backend active-session recovery without implying background audio kept recording. |
