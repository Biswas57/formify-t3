                ...
                <div className="w-full max-w-md py-8">
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <button
                            ...
                            className="w-full bg-[#2149A1] hover:bg-[#1a3a87] text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 hover:scale-[1.01] active:scale-[0.98] active:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2 mt-2"
                        >
